...
public abstract class MessageRouter {
	// Custom method to retrieve the time when message transfer started
	public double time_when_message_transfer_started;
	public double getTimeWhenMessageTransferStarted(){
		return this.time_when_message_transfer_started;
	}

	// Custom method to set the time when message transfer started
	public void setTimeWhenMessageTransferStarted(double value){
		this.time_when_message_transfer_started = value;
	}	
	...
	public int receiveMessage(Message m, DTNHost from) {
		...
		this.setTimeWhenMessageTransferStarted(SimClock.getTime());
