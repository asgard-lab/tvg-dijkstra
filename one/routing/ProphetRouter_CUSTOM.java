 ...
 */
public class ProphetRouter_CUSTOM extends ActiveRouter {
	 ...
	 */
	public ProphetRouter_CUSTOM(Settings s) {
		super(s);
	 ...
	 */
	protected ProphetRouter_CUSTOM(ProphetRouter_CUSTOM r) {
		super(r);
	...
	private void updateTransitivePreds(DTNHost host) {
		...
		assert otherRouter instanceof ProphetRouter_CUSTOM : "PRoPHET only works " + 
			" with other routers of same type";
		
		double pForHost = getPredFor(host); // P(a,b)
		Map<DTNHost, Double> othersPreds = 
			((ProphetRouter_CUSTOM)otherRouter).getDeliveryPreds();
	...
	private Tuple<Message, Connection> tryOtherMessages() {
		...
		for (Connection con : getConnections()) {
			...
			ProphetRouter_CUSTOM othRouter = (ProphetRouter_CUSTOM)other.getRouter();
	...
	private class TupleComparator implements Comparator 
		...
		public int compare(Tuple<Message, Connection> tuple1,
			...
			double p1 = ((ProphetRouter_CUSTOM)tuple1.getValue().
					getOtherNode(getHost()).getRouter()).getPredFor(
					tuple1.getKey().getTo());
			// -"- tuple2...
			double p2 = ((ProphetRouter_CUSTOM)tuple2.getValue().
					getOtherNode(getHost()).getRouter()).getPredFor(
					tuple2.getKey().getTo());
	...
	public MessageRouter replicate() {
		ProphetRouter_CUSTOM r = new ProphetRouter_CUSTOM(this);
		return r;
	}
