...
abstract public class NetworkInterface implements ModuleCommunicationListener {
	...
	public boolean isActive() {
		boolean active = getAh().isActive(this.activenessJitterValue);
	...
	public ActivenessHandler getAh() {
		return ah;
	}

	public void setAh(ActivenessHandler ah) {
		this.ah = ah;
	}
