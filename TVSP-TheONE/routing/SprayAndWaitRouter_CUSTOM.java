 ...
 *
 */
public class SprayAndWaitRouter_CUSTOM extends ActiveRouter {
	...
	public SprayAndWaitRouter_CUSTOM(Settings s) {
		super(s);
	 ...
	 */
	protected SprayAndWaitRouter_CUSTOM(SprayAndWaitRouter_CUSTOM r) {
		super(r);
	...
	@Override
	public SprayAndWaitRouter_CUSTOM replicate() {
		return new SprayAndWaitRouter_CUSTOM(this);
	}
