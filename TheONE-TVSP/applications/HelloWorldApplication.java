...
public class HelloWorldApplication extends Application {
	 ...
	 */
	public HelloWorldApplication(Settings s) {
	 ...
	 * @param a
	 */
	public HelloWorldApplication(HelloWorldApplication a) {
		super(a);
	...
	public Message handle(Message msg, DTNHost host) {
		...
		if (msg.getTo()==host && type.equalsIgnoreCase("ping")) {
			...
			super.sendEventToListeners("GotPingTRALALA", null, host);
			super.sendEventToListeners("SentPongTROLOLO", null, host);
		}
		
		// Received a pong reply
		if (msg.getTo()==host && type.equalsIgnoreCase("pong")) {
			// Send event to listeners
			super.sendEventToListeners("GotPongTROLOLO", null, host);
		}
	...
	public Application replicate() {
		return new HelloWorldApplication(this);
	}
