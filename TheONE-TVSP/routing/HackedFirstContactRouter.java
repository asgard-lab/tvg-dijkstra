...
/**
 * Hacked version of First Contact router (Hack by ÁLVARO SHIOKAWA ALVAREZ) that ensures connections that are still up
 * when simulation end are properly finished!
 */
public class HackedFirstContactRouter extends ActiveRouter {
	 ...
	 */
	public HackedFirstContactRouter(Settings s) {
		super(s);
	}
	 ...
	 */
	protected HackedFirstContactRouter(HackedFirstContactRouter r) {
		super(r);
	}
	...
	@Override
	public HackedFirstContactRouter replicate() {
		return new HackedFirstContactRouter(this);
	}
